document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        // Fetch salon details
        const salonResponse = await fetch(`http://localhost:8080/api/v1/salons/${salonId}`, {
            headers: {
        ...
        const servicesResponse = await fetch(`http://localhost:8080/api/v1/salons/${salonId}/services`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        });
